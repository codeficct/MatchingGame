...
namespace MatchingGame.Vistas.LoginPage
{
    ...
    public partial class AvatarsPage : ContentPage
    {
        ...
        string imageSelected = "https://i.ibb.co/DRd03qy/5.png";
        ...
        public void GenerateAvatars(ref Grid grid)
        {
            ...
            for (int r = 0; r < rows; r++)
                for (int c = 0; c < columns; c++)
                {
                    ...
                    {
                        //((ImageButton)sender).BorderColor = Color.FromHex("#0099ff");
        ...
        {
            await Navigation.PushAsync(new RegisterPage(imageSelected));
        }
